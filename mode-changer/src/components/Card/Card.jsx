...
export default function Card() {
  ...
  : "bg-white border border-gray-200 text-gray-900";
    ...
    return (
        <div className={`w-full max-w-sm rounded-lg shadow ${cardClass}`}>
            <a href="/">
            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className={`text-xl font-semibold tracking-tight ${themeMode === "light" ? "text-black" : "text-white"}`}>
                ...
                <div className="flex items-center justify-between">
                    <span className={`text-3xl font-bold ${themeMode === "light" ? "text-black" : "text-white"}}`}>$599</span>
                    <a
                        href="/"
